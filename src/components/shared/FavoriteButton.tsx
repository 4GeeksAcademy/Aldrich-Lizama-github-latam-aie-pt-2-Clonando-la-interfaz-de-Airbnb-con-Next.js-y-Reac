...
const FavoriteButton: React.FC<FavoriteButtonProps> = ({ alojamientoId }) => {
  const { isFavorite, toggleFavorite } = useFavorites();
  const liked = isFavorite(alojamientoId);
